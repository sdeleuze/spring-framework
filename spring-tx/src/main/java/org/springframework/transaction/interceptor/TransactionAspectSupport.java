...
public abstract class TransactionAspectSupport implements BeanFactoryAware, InitializingBean {
	...
	protected Object invokeWithinTransaction(Method method, @Nullable Class<?> targetClass,
		...
		if (this.reactiveAdapterRegistry != null && tm instanceof ReactiveTransactionManager) {
			...
			if (corInv != null) {
				callback = () -> KotlinDelegate.invokeSuspendingFunction(corInv, method, corInv.getTarget(), corInv.getArguments());
			}
	...
	private static class KotlinDelegate {
		...
		public static Publisher<?> invokeSuspendingFunction(CoroutinesInvocationCallback callback, Method method, Object target, Object... args) {
