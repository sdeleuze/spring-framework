...
/**
 * A common delegate for detecting Kotlin's presence and for identifying Kotlin types. All methods of this class can be
...
public abstract class KotlinDetector {
	...
	public static boolean isSuspendingFunction(Method method) {
		...
		return (parameterCount > 0 &&
				kotlinCoroutineContinuation == method.getParameterTypes()[parameterCount - 1]);
	}
