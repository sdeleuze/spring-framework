...
public class ApplicationContextAotGenerator {
	...
	private void createComponentIndex(GeneratedFiles generatedFiles) {
		...
		ClassPathScanningCandidateComponentProvider.INDEX.keySet().forEach(className -> props.put(className, String.join(",", ClassPathScanningCandidateComponentProvider.INDEX.get(className))));
