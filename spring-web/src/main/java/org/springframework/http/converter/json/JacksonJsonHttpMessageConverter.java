...
public class JacksonJsonHttpMessageConverter extends AbstractJacksonHttpMessageConverter {
	...
	/**
	 * Construct a new {@link JacksonJsonHttpMessageConverter} loading {@link tools.jackson.databind.JacksonModule}s
	 * using JDK {@link java.util.ServiceLoader} facility.
	...
	/**
	 * Construct a new {@link JacksonJsonHttpMessageConverter} with a custom {@link ObjectMapper}.
