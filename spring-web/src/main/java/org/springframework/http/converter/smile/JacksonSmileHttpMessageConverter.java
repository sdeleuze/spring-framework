...
public class JacksonSmileHttpMessageConverter extends AbstractJacksonHttpMessageConverter {
	...
	/**
	 * Construct a new {@link JacksonSmileHttpMessageConverter} loading {@link tools.jackson.databind.JacksonModule}s
	 * using JDK {@link java.util.ServiceLoader} facility.
	...
	public JacksonSmileHttpMessageConverter() {
		this(SmileMapper.builder()
				...
				.addModules(MapperBuilder.findModules(JacksonSmileHttpMessageConverter.class.getClassLoader()))
	...
	/**
	 * Construct a new {@link JacksonSmileHttpMessageConverter} with a custom {@link SmileMapper}.
	 * @see SmileMapper#builder()
	 */
	public JacksonSmileHttpMessageConverter(SmileMapper mapper) {
		super(mapper, new MediaType("application", "x-jackson-smile"));
	}
