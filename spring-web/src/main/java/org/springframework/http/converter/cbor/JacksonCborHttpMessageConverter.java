...
public class JacksonCborHttpMessageConverter extends AbstractJacksonHttpMessageConverter {
	...
	/**
	 * Construct a new {@link JacksonCborHttpMessageConverter} loading {@link tools.jackson.databind.JacksonModule}s
	 * using JDK {@link java.util.ServiceLoader} facility.
	...
	public JacksonCborHttpMessageConverter() {
		this(CBORMapper.builder()
				...
				.addModules(MapperBuilder.findModules(JacksonCborHttpMessageConverter.class.getClassLoader()))
	...
	/**
	 * Construct a new {@link JacksonJsonHttpMessageConverter} with a custom {@link CBORMapper}.
