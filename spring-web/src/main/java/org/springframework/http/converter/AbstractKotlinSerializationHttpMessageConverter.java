...
public abstract class AbstractKotlinSerializationHttpMessageConverter<T extends SerialFormat> extends AbstractSmartHttpMessageConverter<Object> {
	...
	@Override
	public final Object readInternal(ResolvableType type, HttpInputMessage inputMessage, @Nullable Map<String, Object> hints)
	 ...
	 * @param resolvableType the resolvable type to find a serializer for
