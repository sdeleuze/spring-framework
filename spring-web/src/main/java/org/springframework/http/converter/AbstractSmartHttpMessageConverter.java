...
public abstract class AbstractSmartHttpMessageConverter<T> extends AbstractHttpMessageConverter<T>
	 ...
	 */
	@Override
	public final void write(final T t, ResolvableType type, @Nullable MediaType contentType,
	...
	protected T readInternal(Class<? extends T> clazz, HttpInputMessage inputMessage)
		...
		return readInternal(ResolvableType.forClass(clazz), inputMessage, null);
	}

	@Override
	public final T read(ResolvableType type, HttpInputMessage inputMessage, @Nullable Map<String, Object> hints)
			throws IOException, HttpMessageNotReadableException {

		return readInternal(type, inputMessage, hints);
	}

	protected abstract T readInternal(ResolvableType type, HttpInputMessage inputMessage, @Nullable Map<String, Object> hints)
			throws IOException, HttpMessageNotReadableException;
