...
public class JacksonYamlHttpMessageConverter extends AbstractJacksonHttpMessageConverter {
	...
	/**
	 * Construct a new {@link JacksonYamlHttpMessageConverter} loading {@link tools.jackson.databind.JacksonModule}s
	 * using JDK {@link java.util.ServiceLoader} facility.
	...
	public JacksonYamlHttpMessageConverter() {
		this(YAMLMapper.builder()
				...
				.addModules(MapperBuilder.findModules(JacksonYamlHttpMessageConverter.class.getClassLoader()))
	...
	/**
	 * Construct a new {@link JacksonYamlHttpMessageConverter} with a custom {@link YAMLMapper}.
