...
public class JacksonCborEncoder extends AbstractJacksonEncoder {
	...
	public JacksonCborEncoder() {
		this(CBORMapper.builder()
				...
				.addModules(MapperBuilder.findModules(JacksonCborEncoder.class.getClassLoader()))
	...
	/**
	 * Construct a new {@link JacksonCborEncoder} with a custom {@link CBORMapper}.
	...
	/**
	 * Construct a new {@link JacksonCborEncoder} with custom {@link CBORMapper} and {@link MimeType}s.
	 * @see CBORMapper#builder()
	 */
