...
class KotlinSerializationJsonHttpMessageConverterTests {
	...
	fun canReadJson() {
		...
		assertThat(converter.canRead(ResolvableType.forType(typeTokenOf<Map<String, SerializableBean>>()), MediaType.APPLICATION_JSON)).isTrue()
		assertThat(converter.canRead(List::class.java, MediaType.APPLICATION_JSON)).isFalse()
		assertThat(converter.canRead(ResolvableType.forType(typeTokenOf<List<SerializableBean>>()), MediaType.APPLICATION_JSON)).isTrue()
		assertThat(converter.canRead(Set::class.java, MediaType.APPLICATION_JSON)).isFalse()
		assertThat(converter.canRead(ResolvableType.forType(typeTokenOf<Set<SerializableBean>>()), MediaType.APPLICATION_JSON)).isTrue()

		assertThat(converter.canRead(ResolvableType.forType(typeTokenOf<List<Int>>()), MediaType.APPLICATION_JSON)).isTrue()
		assertThat(converter.canRead(ResolvableType.forType(typeTokenOf<ArrayList<Int>>()), MediaType.APPLICATION_JSON)).isTrue()
		assertThat(converter.canRead(ResolvableType.forType(typeTokenOf<List<Int>>()), MediaType.APPLICATION_PDF)).isFalse()

		assertThat(converter.canRead(ResolvableType.forType(typeTokenOf<Ordered>()), MediaType.APPLICATION_JSON)).isFalse()
		assertThat(converter.canRead(ResolvableType.forType(typeTokenOf<List<Ordered>>()), MediaType.APPLICATION_JSON)).isFalse()
	...
	fun canWriteJson() {
		...
		assertThat(converter.canWrite(ResolvableType.forType(typeTokenOf<Map<String, SerializableBean>>()), Map::class.java, MediaType.APPLICATION_JSON)).isTrue()
		assertThat(converter.canWrite(List::class.java, MediaType.APPLICATION_JSON)).isFalse()
		assertThat(converter.canWrite(ResolvableType.forType(typeTokenOf<List<SerializableBean>>()), List::class.java, MediaType.APPLICATION_JSON)).isTrue()
		assertThat(converter.canWrite(Set::class.java, MediaType.APPLICATION_JSON)).isFalse()
		assertThat(converter.canWrite(ResolvableType.forType(typeTokenOf<Set<SerializableBean>>()), Set::class.java, MediaType.APPLICATION_JSON)).isTrue()

		assertThat(converter.canWrite(ResolvableType.forType(typeTokenOf<List<Int>>()), List::class.java, MediaType.APPLICATION_JSON)).isTrue()
		assertThat(converter.canWrite(ResolvableType.forType(typeTokenOf<ArrayList<Int>>()), List::class.java, MediaType.APPLICATION_JSON)).isTrue()
		assertThat(converter.canWrite(ResolvableType.forType(typeTokenOf<List<Int>>()), List::class.java, MediaType.APPLICATION_PDF)).isFalse()

		assertThat(converter.canWrite(ResolvableType.forType(typeTokenOf<Ordered>()), Ordered::class.java, MediaType.APPLICATION_JSON)).isFalse()

		assertThat(converter.canWrite(ResolvableType.forType(ResolvableType.NONE.type), SerializableBean::class.java, MediaType.APPLICATION_JSON)).isFalse()
