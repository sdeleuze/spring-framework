...
public interface RequestBodyAdvice {
	...
	/**
	 * Invoked to determine hints if the converter is a {@link SmartHttpMessageConverter}.
	 * @param parameter the target method parameter
	 * @param targetType the target type, not necessarily the same as the method
	 * parameter type, for example, for {@code HttpEntity<String>}.
	 * @param converterType the selected converter type
	 ...
	 */
	default @Nullable Map<String, Object> determineHints(MethodParameter parameter,
