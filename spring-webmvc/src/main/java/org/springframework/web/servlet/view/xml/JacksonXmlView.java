 ...
 * </ul>
 *
 * <p>No default constructor is provided on purpose to avoid recreating a new {@link XmlMapper} for
 * each instantiation of a {@code JacksonXmlView}.
 *
...
public class JacksonXmlView extends AbstractJacksonView {
	...
	/**
	 * Construct a new {@code JacksonXmlView} using the provided {@link XmlMapper}
