...
import org.springframework.binding.jackson.AutowiredHandlerInstantiator;
...
class StandaloneMockMvcBuilderTests {
	...
	void springHandlerInstantiator() {
		...
		builder.build();
		AutowiredHandlerInstantiator instantiator = new AutowiredHandlerInstantiator(builder.wac.getAutowireCapableBeanFactory());
